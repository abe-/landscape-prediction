...
from utils import get_train_batch, get_test_batch, get_predict_batch
...
# AGF 31/12/2017
    print '-P/--predict_only  (Only runs a predict step)'
# /AGF
...
def main():
    ...
    try:
        # AGF 31/12/2017
        opts, _ = getopt.getopt(sys.argv[1:], 'l:t:r:a:n:s:OTPH',
                                ['load_path=', 'test_dir=', 'recursions=', 'adversarial=', 'name=',
                                 'steps=', 'overwrite', 'test_only', 'predict_only','help', 'stats_freq=',

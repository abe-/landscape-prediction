...
nt = 5 # number of timesteps used for sequences in training # orig: 10
...
lr_schedule = lambda epoch: 0.0025 if epoch < 75 else 0.00025    # start with lr of 0.001 and then drop to 0.0001 after 75 epochs

...
#lr_schedule = lambda epoch: lr if epoch < nb_epoch else 0.1*lr    # start with lr of 0.001 and then drop to 0.0001 after 75 epochs

lr_schedule = lambda epoch: lr * (1 -0.9*epoch/float(nb_epoch))  
